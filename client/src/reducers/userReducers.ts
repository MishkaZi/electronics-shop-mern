...
export const profileUpdateReducer = (state = { userInfo: {}, success: false, loading: false, error: '' },
...
export const userUpdateReducer = (state = { user: {}, loading: false, error: '', success: false },
    action: UsersAction) => {
    switch (action.type) {
