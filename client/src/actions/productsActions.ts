...
export const listTopProducts = () => async (dispatch: AppDispatch) => {
    try {
...
export const createProduct = () => async (dispatch: AppDispatch, getState: any) => {
    try {
        dispatch({
...
export const updateProduct = (product: ProductModel) => async (dispatch: AppDispatch, getState: any) => {
    try {
        dispatch({
...
export const createProductReview = (productId, review) => async (dispatch: AppDispatch, getState: any) => {
    try {
        dispatch({
