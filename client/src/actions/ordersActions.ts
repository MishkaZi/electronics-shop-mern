...
export const payOrder = (orderId: string, paymentResult) => async (dispatch: AppDispatch, getState: any) => {
    try {
        dispatch({
...
export const deliverOrder = (orderId: string) => async (dispatch: AppDispatch, getState: any) => {
    try {
        dispatch({
...
export const listMyOrders = () => async (dispatch: AppDispatch, getState: any) => {
    try {
        dispatch({
...
export const listOrders = () => async (dispatch: AppDispatch, getState: any) => {
    try {
        dispatch({
